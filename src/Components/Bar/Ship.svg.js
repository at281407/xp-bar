...
class ShipSvg extends Component {
  render () {
    return (
      <Svg {...this.props} mask="url('/images/gold.jpg') no-repeat 100% 100%" id="svg2" xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" height="100%" width="80%" viewBox="0 0 200 115" version="1.0">
          <defs>
